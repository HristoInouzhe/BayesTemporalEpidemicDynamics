...
#ifndef SIR_FUNCTIONS_H
#define SIR_FUNCTIONS_H
...
int fS(int Ns, realtype t, N_Vector y, N_Vector ydot, int iS, N_Vector yS, N_Vector ySdot, void *user_data, N_Vector tmp1, N_Vector tmp2);

//static int ewt(N_Vector y, N_Vector w, void *user_data);

/* Prototypes of private functions */

void SIR_CVODES_Incidence(double results_y[][num_out_cvodes], double results_s[][num_out_cvodes][kNumParam - 2], double state_params[kNumParam - 2], double degree, double m, double nf, double *knots, double *basis, char *sensitivity_parameters[]);
