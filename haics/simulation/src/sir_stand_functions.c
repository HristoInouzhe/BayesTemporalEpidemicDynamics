...
#define X0 0.0
#define gamma0 1e-2 // 1e-10
#define phiInv0 1e-2 // 1e-10
#define beta0 1e-2 // 1e-10
#define S0_const 1
#define I0_low 1.0
#define I0_const 1
...
void SIR_CVODES_stand_Incidence(double results_y[][num_out_cvodes], double results_s[][num_out_cvodes][kNumParam - 1], double state_params[kNumParam - 1],
